...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-purple-900 to-gray-800 px-4">
      <motion.div
        className="backdrop-blur-lg bg-white/10 border border-white/20 p-10 rounded-3xl shadow-2xl w-full max-w-md space-y-6"
        ...
        >
          <Form className="space-y-6">
            ...
            <button
              ...
              bg-purple-600 hover:bg-pink-500 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
            >
              Register
            </button>
          </Form>
